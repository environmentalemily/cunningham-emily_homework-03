...
#4 Total biomass as a function of water treatment
...
model4 <- lm(total_g ~ water_treatment + species_name,
             data = drought_exp_clean)
plot(model4) #look at diagnostic
...
**after running model4, it was selcted to be the best model**
